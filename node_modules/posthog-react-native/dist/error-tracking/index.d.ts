...
export declare class ErrorTracking {
    private instance;
    private errorPropertiesBuilder;
    private logger;
    private options;
    /**
    ...
    captureException(input: unknown, additionalProperties: PostHogEventProperties, hint: CoreErrorTracking.EventHint): void;
